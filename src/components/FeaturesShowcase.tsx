        ...
        <div className="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-3">
          {features.map((feature, i) => {
            ...
            return (
              <div
                key={feature.title}
                className="group relative flex flex-col items-start overflow-hidden rounded-[24px] bg-white p-8 transition-all hover:-translate-y-1 hover:shadow-[0_20px_40px_rgba(0,0,0,0.06)]"
              >
