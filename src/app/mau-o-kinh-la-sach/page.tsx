...
export const metadata: Metadata = { title: "Cửa ô kính lá sách Mividoor", description: "Các mẫu cửa ô kính lá sách composite Mividoor giúp lấy sáng, thông thoáng và tăng điểm nhấn cho nội thất.", alternates: { canonical: "https://mividoor.vn/mau-o-kinh-la-sach/" } };
...
export default function CategoryPage() {
  const filteredProducts = productCatalog.filter(p => p.name.toLowerCase().includes("ô kính") || p.name.toLowerCase().includes("lá sách"));
    return (
    <>
      <ProductCollectionJsonLd title="Cửa ô kính lá sách Mividoor" path="/mau-o-kinh-la-sach/" products={filteredProducts} />
      <div className="relative w-full bg-white p-4 md:p-6">
        ...
        <div className="relative w-full rounded-[16px] overflow-hidden bg-[#F2F2EC] pt-32 pb-24 min-h-[50vh] flex flex-col justify-center">
          ...
          <img 
            ...
            alt="Các mẫu cửa ô kính lá sách Mividoor" 
