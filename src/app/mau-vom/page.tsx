...
export const metadata: Metadata = { title: "Cửa vòm composite Mividoor", description: "Các mẫu cửa vòm composite Mividoor tạo vẻ mềm mại, độc đáo và sang trọng cho công trình.", alternates: { canonical: "https://mividoor.vn/mau-vom/" } };

export default function CategoryPage() {
  const filteredProducts = productCatalog.filter(p => p.name.toLowerCase().includes("vòm"));
    return (
    <>
      <ProductCollectionJsonLd title="Cửa vòm Mividoor" path="/mau-vom/" products={filteredProducts} />
      <div className="relative w-full bg-white p-4 md:p-6">
        ...
        <div className="relative w-full rounded-[16px] overflow-hidden bg-[#F2F2EC] pt-32 pb-24 min-h-[50vh] flex flex-col justify-center">
          ...
          <img 
            ...
            alt="Các mẫu cửa vòm composite Mividoor" 
