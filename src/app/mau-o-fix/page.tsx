...
export const metadata: Metadata = { title: "Cửa ô fix Mividoor - Mẫu cửa composite", description: "Xem các mẫu cửa ô fix Mividoor với thiết kế đa dạng, bền đẹp và phù hợp nhiều phong cách nội thất.", alternates: { canonical: "https://mividoor.vn/mau-o-fix/" } };

export default function CategoryPage() {
  const filteredProducts = productCatalog.filter(p => p.name.toLowerCase().includes("fix"));
    return (
    <>
      <ProductCollectionJsonLd title="Cửa ô fix Mividoor" path="/mau-o-fix/" products={filteredProducts} />
      <div className="relative w-full bg-white p-4 md:p-6">
        ...
        <div className="relative w-full rounded-[16px] overflow-hidden bg-[#F2F2EC] pt-32 pb-24 min-h-[50vh] flex flex-col justify-center">
          ...
          <img 
            ...
            alt="Các mẫu cửa ô fix Mividoor" 
