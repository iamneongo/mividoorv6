  ...
  return (
    <>
      <div className="relative w-full bg-white p-4 md:p-6 min-h-[50vh]">
        <SiteHeader />
        <div className="relative w-full rounded-[16px] overflow-hidden pt-20 pb-12 lg:pt-24 lg:pb-16 h-full bg-[url('/mividoor/images/about-bg-hoinganh.webp')] bg-fixed bg-cover bg-center">
