...
export const metadata: Metadata = { title: "Cửa soi huỳnh CNC Mividoor", description: "Các mẫu cửa soi huỳnh CNC Mividoor với đường nét chính xác, tạo chiều sâu và điểm nhấn cho không gian.", alternates: { canonical: "https://mividoor.vn/mau-soi-huynh/" } };

export default function CategoryPage() {
  const filteredProducts = productCatalog.filter(p => p.name.toLowerCase().includes("soi huỳnh"));
    return (
    <>
      <ProductCollectionJsonLd title="Cửa soi huỳnh CNC Mividoor" path="/mau-soi-huynh/" products={filteredProducts} />
      <div className="relative w-full bg-white p-4 md:p-6">
        ...
        <div className="relative w-full rounded-[16px] overflow-hidden bg-[#F2F2EC] pt-32 pb-24 min-h-[50vh] flex flex-col justify-center">
          ...
          <img 
            ...
            alt="Các mẫu cửa soi huỳnh CNC Mividoor" 
