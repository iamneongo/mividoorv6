...
export const metadata: Metadata = { title: "Cửa lùa composite Mividoor", description: "Các mẫu cửa lùa composite Mividoor tối ưu diện tích, phù hợp nhà ở và công trình hiện đại.", alternates: { canonical: "https://mividoor.vn/mau-lua/" } };

export default function CategoryPage() {
  const filteredProducts = productCatalog.filter(p => p.name.toLowerCase().includes("lùa"));
    return (
    <>
      <ProductCollectionJsonLd title="Cửa lùa composite Mividoor" path="/mau-lua/" products={filteredProducts} />
      <div className="relative w-full bg-white p-4 md:p-6">
        ...
        <div className="relative w-full rounded-[16px] overflow-hidden bg-[#F2F2EC] pt-32 pb-24 min-h-[50vh] flex flex-col justify-center">
          ...
          <img 
            ...
            alt="Các mẫu cửa lùa composite Mividoor" 
