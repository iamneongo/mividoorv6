...
export const metadata: Metadata = { title: "Cửa 2 cánh Mividoor - Mẫu cửa composite", description: "Khám phá các mẫu cửa composite 2 cánh Mividoor cho nhà phố, biệt thự và không gian rộng.", alternates: { canonical: "https://mividoor.vn/mau-2-canh/" } };

export default function CategoryPage() {
  const filteredProducts = productCatalog.filter(p => p.name.toLowerCase().includes("2 cánh"));
    return (
    <>
      <ProductCollectionJsonLd title="Cửa 2 cánh Mividoor" path="/mau-2-canh/" products={filteredProducts} />
      <div className="relative w-full bg-white p-4 md:p-6">
        ...
        <div className="relative w-full rounded-[16px] overflow-hidden bg-[#F2F2EC] pt-32 pb-24 min-h-[50vh] flex flex-col justify-center">
          ...
          <img 
            ...
            alt="Các mẫu cửa composite 2 cánh Mividoor" 
