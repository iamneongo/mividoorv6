...
export const metadata: Metadata = { title: "Cửa nẹp nhôm nẹp inox Mividoor", description: "Tham khảo các mẫu cửa composite đi nẹp nhôm và nẹp inox Mividoor cho không gian sang trọng.", alternates: { canonical: "https://mividoor.vn/mau-di-nep/" } };

export default function CategoryPage() {
  const filteredProducts = productCatalog.filter(p => p.name.toLowerCase().includes("nẹp"));
    return (
    <>
      <ProductCollectionJsonLd title="Cửa nẹp nhôm nẹp inox Mividoor" path="/mau-di-nep/" products={filteredProducts} />
      <div className="relative w-full bg-white p-4 md:p-6">
        ...
        <div className="relative w-full rounded-[16px] overflow-hidden bg-[#F2F2EC] pt-32 pb-24 min-h-[50vh] flex flex-col justify-center">
          ...
          <img 
            ...
            alt="Các mẫu cửa nẹp nhôm nẹp inox Mividoor" 
